    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <nav className="flex items-center h-12 sm:h-14 px-3 sm:px-4 text-sm font-medium">
        ...
        <div className="flex-1 flex items-center">
          <button
            type="button"
            className="flex items-center gap-2 shrink-0 cursor-pointer transition-opacity hover:opacity-80 bg-transparent border-none p-0 text-foreground focus:outline-none"
            onClick={() => {
        ...
        <div className="flex-1 flex justify-end items-center gap-1">
          ...
          <a
            ...
            className="hidden md:inline-flex items-center justify-center shrink-0 size-8 text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors duration-200 cursor-pointer"
            aria-label="GitHub Repository"
            title="View GitHub Source"
          >
            <svg className="size-4 fill-current" viewBox="0 0 16 16">
          ...
          <Button
            ...
            className="md:hidden shrink-0 size-8 active:scale-90 transition-all duration-200"
            aria-label="Toggle navigation menu"
          >
            {isMenuOpen ? (
              <X className="size-4 text-foreground transition-all duration-200 rotate-90" />
            ) : (
              <Menu className="size-4 text-foreground transition-all duration-200" />
            )}
          </Button>
        </div>
      </nav>
